...
def main():
    ...
    df.drop(["brent_crude_oil","wti_crude_oil","gasoline_price" ,"usd_index","real_usd_index","usd_eur","volatility_index","ind_production_overall",
        "ind_prod_drill","cap_util","cap_util_oil_gas","natgas_electric","cpi","ppi","ppidp","pce"],axis=1,inplace=True)
    print(df.head())
