...
def main():
    ...
    df.drop(columns=['pce', 'usd_index', 'ppi', 'natgas_electric', 'vehicle_sales',
                     'ind_production_overall', 'usd_eur', 'cap_util_oil_gas', 'gasoline_price', 'ppidp', 'cpi'],
            inplace=True, axis=1, errors='ignore')

    # cols=['EventCode_1723', 'EventCode_191', 'EventCode_035', 'EventCode_128', 'brent_crude_oil','AvgTone','natural_gas',
    #       'ind_prod_drill','wti_crude_oil']
    # df=df[cols]
