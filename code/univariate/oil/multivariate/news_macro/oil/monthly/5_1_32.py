...
def main():
    ...
    # ── Load ─────────────────────────────────────────────────────
    dl = DataLoader()
    df = dl.combine_all_as_monthly(exclude=[])
    cols = [
        'EventCode_020', 'EventCode_021', 'EventCode_022', 'EventCode_023', 'EventCode_024', 'EventCode_025',
        'EventCode_070', 'EventCode_071', 'EventCode_072', 'EventCode_073', 'EventCode_074', 'EventCode_075',
        'EventCode_030', 'EventCode_031', 'EventCode_032', 'EventCode_033', 'EventCode_034', 'EventCode_035',
        'EventCode_140', 'EventCode_141', 'EventCode_142', 'EventCode_143', 'EventCode_144', 'EventCode_145',
        'EventCode_180', 'EventCode_181', 'EventCode_182', 'EventCode_183', 'EventCode_184', 'EventCode_185',
        'EventCode_186','EventCode_190', 'EventCode_191', 'EventCode_192', 'EventCode_193', 'EventCode_194',
        'EventCode_040', 'EventCode_041', 'EventCode_042', 'EventCode_043', 'EventCode_044', 'EventCode_045',
        'EventCode_046','EventCode_010', 'EventCode_011', 'EventCode_012', 'EventCode_013', 'EventCode_014',
        'EventCode_016', 'EventCode_017', 'EventCode_018', 'EventCode_019', 'EventCode_110', 'EventCode_111',
        'EventCode_112', 'EventCode_113', 'EventCode_114', 'EventCode_115','EventCode_116','EventCode_015',
        'EventCode_195','brent_crude_oil','cap_util','wti_crude_oil','natural_gas','volatility_index','GoldsteinScale',
        'AvgTone', 'real_usd_index','ind_prod_drill'
    ]
    df=df[cols]
    ...
    # df.drop(['real_usd_index','ppidp','pce','ppidp','ppi','cap_util','ind_prod_drill'],inplace=True,axis=1)
    print(df.head())
