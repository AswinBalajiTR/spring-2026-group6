...
def main():
    ...
    # ── Load ─────────────────────────────────────────────────────
    dl = DataLoader()
    df = dl.combine_all_as_monthly(exclude=['pce','brent_crude_oil','ppi','natgas_electric', 'usd_index','usd_eur','cpi',
                     'cap_util_oil_gas','ind_production_overall','gasoline_price','ppidp'])
