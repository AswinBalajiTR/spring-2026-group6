...
DATA_PATH = os.path.join(PROJECT_ROOT, "Data", "wti_crude_oil.csv")
...
s = eda.to_monthly(s, agg="mean")
eda.plot_series(s, name="WTI_Monthly")
eda.stationarity_tests(s, name="WTI_Monthly")

s_diff = eda.take_difference(s, periods=1)
eda.plot_series(s_diff, name="WTI_Monthly_diff")
eda.stationarity_tests(s_diff, name="WTI_Monthly_diff")
eda.plot_acf_pacf(s_diff, name="WTI_Monthly_diff", lags=40)
eda.seasonality_test(s_diff, name="WTI_Monthly_diff", period=12)
eda.decompose(s_diff, name="WTI_Monthly_diff", period=12, model="additive")
...
# ── Fit ARIMA models ──────────────────────────────────────────────────────────
orders   = [(1,1,1), (0,1,1), (1,1,0),(2,1,0)]
fitted_models = {}
forecasts     = {}
...
ax.set_title("WTI_Monthly – ARIMA Forecasts vs Actual")
ax.set_xlabel("Date")
ax.set_ylabel("Price")
ax.legend()
fig.tight_layout()
